---
layout: default
title: Dontbeacunt - Enterprise Solution
...
<div class="tiation-hero">
  ...
  <div class="hero-content">
    ...
    <h1 class="hero-title">
      ...
      <span class="gradient-text">Dontbeacunt</span>
    </h1>
    ...
    <div class="hero-cta">
      ...
      <a href="https://github.com/tiation/dontbeacunt" class="btn-tertiary">📁 View Code</a>
    </div>
  </div>
</div>
...
```bash
# Build Docker image
docker build -t dontbeacunt .

# Run container
docker run -p 8080:8080 dontbeacunt
```
...
### 📞 Getting Help
- **📚 Documentation**: [Full documentation](https://tiation.github.io/dontbeacunt)
- **❓ FAQ**: [Frequently asked questions](faq.md)
- **🐛 Issues**: [GitHub Issues](https://github.com/tiation/dontbeacunt/issues)
- **💬 Discussions**: [GitHub Discussions](https://github.com/tiation/dontbeacunt/discussions)
